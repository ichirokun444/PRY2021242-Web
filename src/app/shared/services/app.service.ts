...
import { SetCompanyModules } from "@app/store/actions/app.action";
...
export class AppService {
  ...
  waitInitialDataInterval: any = null;
  ...
  initApp() {
    ...
    let modules: CompanyModule[] = [
      ...
      },
      {
        ...
        label: 'Historias Clinicas Paciente',
        path: '/admin/paciente',
      },
      {
        id: '5',
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>`,
        label: 'Historias Clinicas Doctor',
        path: '/admin/doctor',
      },
      {
        id: '6',
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>`,
        label: 'Historias Clinicas Agendar',
        path: '/admin/doctor-historia',
      },
      {
        id: '6',
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>`,
        label: 'Historias Clinicas Pacientes',
        path: '/admin/doctor-paciente',
      },
      {
        id: '7',
      ...
      },
      {
        ...
        label: 'Poderdantes',
        path: '/admin/poderdantes',
      },
    ];

    modules = modules.filter(it => (permissions[this.user.rol] || []).includes(+it.id));
